      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header bg-dark">
            <a href="caja_compra.php?ddes=0" target="admin" class="btn btn-success"><i class="fa fa-shopping-cart"></i> Realizar
              Nueva Compra </a>
          </div>
          <div class="card-body">
            <table id="tablaInvoice" width="100%" class="table table-striped mt-2 dt-responsive">
              <thead>
                <tr>
                  <th width="10%"><strong>Compra Nro</strong></th>
                  <th width="2%"><strong>Cajero</strong></th>
                  <th width="5%"><strong>Proveedor</strong></th>
  ...
  <script>
    function loadInvoices() {
      $('#tablaInvoice').DataTable({
        ...
        ajax: {
          url: 'php_action/actions.php?request=allInvoicesCompra',
          type: 'GET',
          dataType: 'JSON',
          error: function(msj) {
