...
<!-- codigo imprimir -->
<center>
<div id="muestra" style="font-size:<?php echo $tama.'px'; ?>"><br />
<!-- <iframe frameborder="0" height="100" width="300" src="></iframe> -->
    <table width="310px" border="0">
      <tr>
        ...
        <strong class="empre"><?php echo $empresa; ?></strong><br />
...
<tr>
        <td colspan="3"><center>
          <strong>RECIBIDO: $  <?php echo number_format($ccpago,0,",","."); ?></strong>
        </center></td>
      </tr>
<tr>
        <td colspan="3"><center>
          <strong>VUELTO: $  <?php echo number_format($cambio,0,",","."); ?></strong>
        </center></td>
      </tr>
       <td colspan="3"><center>
<!--               --><?php //if ($iva=='10'){?>
