    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="editors">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" target="admin" href="caja.php?ddes=0">Nueva Venta</a></li>
                    <?php if ($_SESSION['rol'] === 'Administrador') : ?>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" target="admin" href="reportg.php"> Ganancias por Ventas</a>
                    </li>
